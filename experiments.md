...
Using references + LR scheduler
python fof/run.py train --gpus 1 --exp references-and-lr-scheduler --lr 5e-5 --model encdec --batch_size 5 --accumulate_grad_batches 3 --use_scibert --pl_logger wandb --lr_scheduler linear --max_epochs 15 --caption_type normalized --use_references